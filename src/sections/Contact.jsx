        ...
        <footer className='contact-cover'>
            <div className='flex--space-between'>
                ...
                <a className='contact-top' href='#home'>
                    ...
                    <svg width="24" height="24" fill-rule="evenodd" clip-rule="evenodd" ><path style={{ fill: "#1344ff" }} d="M11 2.206l-6.235 7.528-.765-.645 7.521-9 7.479 9-.764.646-6.236-7.53v21.884h-1v-21.883z" /></svg>
                </a>
            </div>
